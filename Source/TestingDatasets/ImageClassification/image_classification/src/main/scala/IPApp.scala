...
object IPApp {
 ...
 val IMAGE_CATEGORIES = List("Apples","cherry","grapes","mango","oranges","papaya","pineapple","strawberry","watermelon")
  ...
  def testImageClassification(sc: SparkContext, path: String): String ={
    ...
    ("Test image predicted as : " + IMAGE_CATEGORIES(p.toInt))
  }
  ...
  def testImage(string: String):String = {
    ...
    System.setProperty("hadoop.home.dir","C:\\Users\\putha\\Desktop\\BA-Assi\\LAb2");
